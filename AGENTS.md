...
- Java、Spring Boot、Web、配置、事务、日志、测试或安全：读取 `../.codex/rules/backend-conventions.md` 和 `../.codex/skills/java-springboot/SKILL.md`。
- MySQL、Flyway、MyBatis XML/注解 SQL、schema、索引、查询、锁、连接或数据库运维：额外读取 `../.codex/rules/database-conventions.md` 与 `../.codex/skills/mysql/SKILL.md`，再按任务读取直接相关 reference。
